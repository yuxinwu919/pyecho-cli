function rinds=CutBadParticles2(x2,y2,z2,cut,bounds,rep)
  n=length(z2);rinds=[1:n];
  z0=mean(z2); sig0=std(z2);
  i00=find(z2>z0+sig0*bounds(1) & z2<z0+sig0*bounds(2)); 
  rinds(i00)=[];
  x1=x2(i00); y1=y2(i00);z1=z2(i00);
  x2=[];y2=[];z2=[];
...
rinds=[rinds i00(inds)']; rinds=sort(rinds);
