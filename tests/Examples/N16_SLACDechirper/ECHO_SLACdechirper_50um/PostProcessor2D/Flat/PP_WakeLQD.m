...
Ncc=15;
dir_in_cc='../../ECHO2D_Antipov2/magn/';
Nss=15;
dir_in_ss='../../ECHO2D_Antipov2/elec/';
dir_out='../../ECHO2D_Antipov2/';
...
Kick=(lossD+lossQ)*200/300e6*(5.578+0.5)
x=[0:0.02:1]*0.85*1e-3;
y=x*Kick*1e3;
out1=[x'*1e3,y'*1e3];
save kickDQ.txt out1 -ascii
